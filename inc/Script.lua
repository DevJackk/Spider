...
if not msg.SudoBase then return "*│*هذا الامر يخص {المطور الاساسي} فقط  \n" end
local GetVerison = https.request( 'https://raw.githubusercontent.com/jack1eljoker1/Spider/main/GetVersion.txt' ) or 0
...
if MsgText[1]== "مبرمج السورس جاك" and msg.type == "pv" then
local inline = {{{text="-جاك اضـغـط هـنـآ ",url="https://t.me/V_P_E"}}}
send_key(msg.sender_user_id_,'   [مبرامج جاك](https://t.me/V_P_E)' ,nil,inline,msg.id_)
return false
end

if MsgText[1]== "يسري مالك السورس" and msg.type == "pv" then
local inline = {{{text="مطور السورس اضـغـط هـنـآ ",url="https://t.me/youssry_hack"}}}
send_key(msg.sender_user_id_,'   [مطور يسري](https://t.me/youssry_hack)' ,nil,inline,msg.id_)
return false
end
...
⚶
☚مْطہـوٌڒٍ  ٳلہسہوٌڒٍسہ  ☞☚ [جاك](https://t.me/V_P_E)  ☛          ⚶                                                           ⚶
☜ مْطہـوٌڒٍ  ٳلہسہوٌڒٍسہ  ☛☜ [يسري](https://t.me/youssry_hack) ☞        ⚶                             ⚶
☚ مْطہـوٌڒٍ  ٳلہسہوٌڒٍسہ  ☞☚ [ديكابريو](https://t.me/D_i_c_a_p_r_i_o1) ☛    ⚶                             ⚶
☚ قہًنٍـاةً  ٳلہسہوٌڒٍسہ   ☞☚ [𝐬𝐨𝐮𝐫𝐜𝐞 𝐬𝐩𝐢𝐝𝐞𝐫](https://t.me/SouRce_Spider) ⚶                           ⚶
⚶ـ⚶ـ⚶ـ⚶ـ⚶ـ⚶ـ⚶ـ⚶ـ⚶ـ⚶ـ⚶ـ⚶ـ⚶ـ⚶ـ⚶ـ⚶ـ
]]
end
...
if Black == 'welcome on' or Black == 'تفعيل اسبايدر' then
if redis:get(Spider..'welc'..msg.chat_id_) == 'on' then
sendMsg(msg.chat_id_,msg.id_,'تم تفعيل اسبايدر سابقا')
else
sendMsg(msg.chat_id_,msg.id_,'تم تفعيل اسبايدر')
redis:set(Spider..'welc'..msg.chat_id_,'on')
end
end
if Text == 'welcome off' or Text == 'تعطيل اسبايدر' then
if redis:get(Spider..'welc'..msg.chat_id_) == 'off' then
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل اسبايدر سابقا')
redis:set(Spider..'welc'..msg.chat_id_,'off')
redis:del(Spider..'welc'..msg.chat_id_,'on')
else
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل اسبايدر')
end
end
...
local keyboard = {
{"يسري مالك السورس","مبرمج السورس جاك"},
{"ضع اسم للبوت","ضع صوره للترحيب"},
{"تفعيل اسبايدر","تعطيل اسبايدر"},
...
elseif Text== "جاك" or Text== "جاك" then return  sendMsg(msg.chat_id_,msg.id_,"[مطور سورس بلاك وسورس اسبايدر ❅](https://t.me/V_P_E)")
