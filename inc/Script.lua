...
redis:set(Spider.."getidstatus"..msg.chat_id_, "Simple")
...
redis:set(Spider..'lock:join:'..msg.chat_id_,true)
...
redis:del(Spider..'lock:join:'..msg.chat_id_)
return "*❍ ** أهلا عزيزي *"..msg.TheRankCmd.."*\n❍ ** تم فتح الدخول بالرابط \n*" 
end


local function iSpider(msg,MsgText)

Channel = redis:get(Spider..'setch') or katrenno
--JoinChannel
function is_JoinChannel(msg)
if redis:get(Spider..'joinchnl') then
...
redis:setex(Spider..'ExpireDate:'..msg.chat_id_, extime, true)
if not redis:get(Spider..'CheckExpire::'..msg.chat_id_) then 
redis:set(Spider..'CheckExpire::'..msg.chat_id_,true) end
sendMsg(msg.chat_id_,msg.id_,'💂🏻‍♀️│تم شحن الاشتراك الى `'..MsgText[2]..'` يوم   ... 👍🏿')
sendMsg(SUDO_ID,0,'💂🏻‍♀️│تم شحن الاشتراك الى `'..MsgText[2]..'` يوم   ... 👍🏿\n🕵🏼️‍♀️│في مجموعه  » »  '..redis:get(Spider..'group:name'..msg.chat_id_))
else
...
if not msg.SudoUser then return "♦️*│*هذا الامر يخص {المطور} فقط  \n💥" end
if MsgText[2] == '1' then
redis:setex(Spider..'ExpireDate:'..msg.chat_id_, 2592000, true)
if not redis:get(Spider..'CheckExpire::'..msg.chat_id_) then 
redis:set(Spider..'CheckExpire::'..msg.chat_id_,true) 
end
sendMsg(msg.chat_id_,msg.id_,'💂🏻‍♀️│تم تفعيل الاشتراك   👍🏿\n📆│ الاشتراك » `30 يوم`  *(شهر)*')
sendMsg(SUDO_ID,0,'💂🏻‍♀️│تم تفعيل الاشتراك  👍🏿\n📆│ الاشتراك » `30 يوم`  *(شهر)*')
end
if MsgText[2] == '2' then
redis:setex(Spider..'ExpireDate:'..msg.chat_id_,7776000,true)
if not redis:get(Spider..'CheckExpire::'..msg.chat_id_) then 
redis:set(Spider..'CheckExpire::'..msg.chat_id_,true) 
end
...
if MsgText[2] == '3' then
redis:set(Spider..'ExpireDate:'..msg.chat_id_,true)
if not redis:get(Spider..'CheckExpire::'..msg.chat_id_) then 
redis:set(Spider..'CheckExpire::'..msg.chat_id_,true) end
...
local check_time = redis:ttl(Spider..'ExpireDate:'..msg.chat_id_)
...
local GroupName = (redis:get(Spider..'group:name'..msg.chat_id_) or '')
redis:set(Spider..'linkGroup'..msg.chat_id_,(data.invite_link_ or ""))
...
users = redis:get(Spider..'user_names:'..v.user_id_) or v.user_id_
x = x + 1
...
if not msg.Director then return "❍ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local Chek_Info = https.request('https://api.telegram.org/bot'..Token..'/getChatMember?chat_id='.. msg.chat_id_ ..'&user_id='.. Spider..'')
...
if not msg.Director and redis:get(Spider..'lock_pin'..msg.chat_id_) then
...
function(arg,data)
if data.ID == "Ok" then
redis:set(Spider..":MsgIDPin:"..msg.chat_id_,msg.reply_id)
...
if not msg.Admin then return "❍ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
if not MsgText[2] and msg.reply_id then
if redis:get(Spider..'lock:kara:'..msg.chat_id_) == 'off' then
...
if redis:get(Spider..'lock:kara:'..msg.chat_id_) == 'on' then
...
local Admins = redis:scard(Spider..'admins:'..msg.chat_id_)
redis:del(Spider..'admins:'..msg.chat_id_)
local NumMDER = redis:scard(Spider..'owners:'..msg.chat_id_)
redis:del(Spider..'owners:'..msg.chat_id_)
local MMEZEN = redis:scard(Spider..'whitelist:'..msg.chat_id_)
redis:del(Spider..'whitelist:'..msg.chat_id_)
...
if not msg.Director then return "❍ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
if not redis:get(Spider..'ExCmdLink'..msg.chat_id_) then
local LinkGp = ExportLink(msg.chat_id_)
if LinkGp then
LinkGp = LinkGp.result
redis:set(Spider..'linkGroup'..msg.chat_id_,LinkGp)
redis:setex(Spider..'ExCmdLink'..msg.chat_id_,120,true)
...
if not msg.Director then return "❍ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
redis:setex(Spider..'linkGroup'..msg.sender_user_id_,300,true)
return '❍ عزيزي قم برسال الرابط الجديد ...🍂'
end

if MsgText[1] == "الرابط" then
if not redis:get(Spider..'linkGroup'..msg.chat_id_) then 
return "❍ ** اوه لا يوجد رابط .\n❍ **لانشاء رابط ارسل { `انشاء رابط` }\n" 
end
local GroupName = redis:get(Spider..'group:name'..msg.chat_id_)
local GroupLink = redis:get(Spider..'linkGroup'..msg.chat_id_)
...
local Text = "❍ رابـط الـمـجـمـوعه ❍ \n"..Flter_Markdown(redis:get(Spider..'group:name'..msg.chat_id_)).." :\n\n["..GroupLink.."]\n"
...
redis:set(Spider..'flood'..msg.chat_id_,MsgText[2]) 
...
if not msg.Director then return "❍ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local Mn3Word = redis:scard(Spider..':Filter_Word:'..msg.chat_id_)
if Mn3Word == 0 then 
return "❍ ** عذراً لا توجد كلمات ممنوعه ليتم حذفها" 
end
redis:del(Spider..':Filter_Word:'..msg.chat_id_)
...
redis:del(Spider..'rulse:msg'..msg.chat_id_)
...
if not msg.Director then return "❍ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
if not redis:get(Spider..'welcome:msg'..msg.chat_id_) then 
return "❍ ** اوه هنالك خطأ .\n❍ عذراً لا يوجد ترحيب ليتم مسحه ." 
end
redis:del(Spider..'welcome:msg'..msg.chat_id_)
...
local NumMnsha = redis:scard(Spider..':Hussain:'..msg.chat_id_)
if NumMnsha ==0 then 
return "❍ عذراً لا يوجد منشى اساسي \n!" 
end
redis:del(Spider..':Hussain:'..msg.chat_id_)
...
if not msg.SudoUser then return "❍ **هذا الامر يخص {المطور} فقط  \n" end
local NumMnsha = redis:scard(Spider..':MONSHA_BOT:'..msg.chat_id_)
if NumMnsha ==0 then 
return "❍ عذراً لا يوجد منشئيين ليتم مسحهم \n!" 
end
redis:del(Spider..':MONSHA_BOT:'..msg.chat_id_)
...
local list = redis:smembers(Spider..'banned:'..msg.chat_id_)
if #list == 0 then return "*❍ لا يوجد مستخدمين محظورين  *" end
message = '❍ ** قائمه الاعضاء المحظورين :\n'
for k,v in pairs(list) do
StatusLeft(msg.chat_id_,v)
end 
redis:del(Spider..'banned:'..msg.chat_id_)
return "❍ **أهلا عزيزي "..msg.TheRankCmd.."   \n❍  تم مسح {* "..#list.." *} من المحظورين  \n"
end

if MsgText[2] == 'المكتومين' then
if not msg.Director then return "❍ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local MKTOMEN = redis:scard(Spider..'is_silent_users:'..msg.chat_id_)
if MKTOMEN ==0 then 
return "❍ ** لا يوجد مستخدمين مكتومين في المجموعه " 
end
redis:del(Spider..'is_silent_users:'..msg.chat_id_)
...
redis:del(Spider..'linkGroup'..msg.chat_id_)
...
if not msg.Creator then return "❍ **هذا الامر يخص {المطور,المنشئ} فقط  \n" end
redis:setex(Spider..'name:witting'..msg.sender_user_id_,300,true)
...
redis:setex(Spider..'photo:group'..msg.chat_id_..msg.sender_user_id_,300,true)
...
if not msg.Creator then return "❍ **هذا الامر يخص {المطور,المنشئ} فقط  \n" end
redis:setex(Spider..'about:witting'..msg.sender_user_id_,300,true) 
...
kick_user(v.user_id_,msg.chat_id_,function(arg,data)  
redis:srem(Spider..':MONSHA_BOT:'..msg.chat_id_,v.user_id_)
redis:srem(Spider..'whitelist:'..msg.chat_id_,v.user_id_)
redis:srem(Spider..'owners:'..msg.chat_id_,v.user_id_)
redis:srem(Spider..'admins:'..msg.chat_id_,v.user_id_)
end)
end
NumMem = NumMem + 1
...
if redis:get(Spider..'lock_id'..msg.chat_id_) then 
local msgs = redis:get(Spider..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 1
GetUserID(msg.sender_user_id_,function(arg,data)
if data.username_ then UserNameID = "@"..data.username_.."" else UserNameID = "" end
local points = redis:get(Spider..':User_Points:'..msg.chat_id_..msg.sender_user_id_)
if points and points ~= "0" then
nko = points
else
nko = '0'
end
local rfih = (redis:get(Spider..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local NumGha = (redis:get(Spider..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local Namei = FlterName(data.first_name_..' '..(data.last_name_ or ""),20)
GetPhotoUser(msg.sender_user_id_,function(arg, data)
if redis:get(Spider.."getidstatus"..msg.chat_id_) == "Photo" then
...
GetUserID(msg.sender_user_id_,function(arg,data)
local msgs = (redis:get(Spider..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
local NumGha = (redis:get(Spider..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local photo = (redis:get(Spider..':photo:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local sticker = (redis:get(Spider..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local voice = (redis:get(Spider..':voice:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local audio = (redis:get(Spider..':audio:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local animation = (redis:get(Spider..':animation:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local edited = (redis:get(Spider..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local video = (redis:get(Spider..':video:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
...
redis:del(Spider..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
return "❍ **تم مسح {* "..msgs.." *} من رسائلك .\n"
end

if MsgText[1]== 'جهاتي' then
return '❍ **  عدد جهاتك المضافة‏‏ ⇜ ❪ '..(redis:get(Spider..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..' ❫ \n.'
end

if MsgText[1] == 'مسح' and MsgText[2] == 'جهاتي'  then
local adduser = redis:get(Spider..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0
if adduser == 0 then  return "❍ **عذرا ليس لديك جهات لكي يتم مسحها" end
redis:del(Spider..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) 
...
local points = redis:get(Spider..':User_Points:'..msg.chat_id_..msg.sender_user_id_) or 0
if points == 0 then  return "❍ **عذرا ليس لديك نقاط لكِ يتم مسحها" end
redis:del(Spider..':User_Points:'..msg.chat_id_..msg.sender_user_id_)
...
GetUserID(msg.sender_user_id_,function(arg,data)
local msgs = (redis:del(Spider..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
local NumGha = (redis:del(Spider..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local photo = (redis:del(Spider..':photo:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local sticker = (redis:del(Spider..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local voice = (redis:del(Spider..':voice:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local audio = (redis:del(Spider..':audio:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local animation = (redis:del(Spider..':animation:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local edited = (redis:del(Spider..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local video = (redis:del(Spider..':video:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
...
if not msg.Admin then return "❍ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
redis:set(Spider..'welcom:witting'..msg.sender_user_id_,true) 
...
if not msg.Admin then return "❍ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
if redis:get(Spider..'welcome:msg'..msg.chat_id_)  then
return Flter_Markdown(redis:get(Spider..'welcome:msg'..msg.chat_id_))
else 
return "❍ **أهلا عزيزي "..msg.TheRankCmd.."  \n❍ نورت المجموعه \n" 
end 
end
...
local groups = redis:smembers(Spider..'group:ids')
...
local pv = redis:smembers(Spider..'users')
local NumPvDel = 0
for i = 1, #pv do
...
redis:setex(Spider..'welcom_ph:witting'..msg.sender_user_id_,300,true) 
...
local Photo_Weloame = redis:get(Spider..':WELCOME_BOT')
if Photo_Weloame then
sendPhoto(msg.chat_id_,msg.id_,Photo_Weloame,[[❍ اهلا انا بوت]]..redis:get(Spider..':NameBot:')..[[ .
...
redis:setex(Spider..'text_sudo:witting'..msg.sender_user_id_,1200,true) 
return '❍ حسننا عزيزي .\n❍ الان قم بارسال الكليشه \n' 
end

if MsgText[1] == "ضع شرط التفعيل" and MsgText[2] and MsgText[2]:match('^%d+$') then 
redis:set(Spider..':addnumberusers',MsgText[2]) 
return '❍ ** تم وضـع شـرط التفعيل البوت اذا كانت المجموعه‏‏ اكثر مـن *【'..MsgText[2]..'】* عضـو  .\n' 
end

if MsgText[1] == "شرط التفعيل" then 
return'❍ ** شـرط التفعيل البوت اذا كانت المجموعه‏‏ اكثر مـن *【'..redis:get(Spider..':addnumberusers')..'】* عضـو .\n' 
end 
end

if MsgText[1] == 'المجموعات' or MsgText[1] == "المجموعات 🌋" then
if not msg.SudoUser then return "❍ **هذا الامر يخص {المطور} فقط  \n" end
return '❍ ** عدد المجموعات المفعلة » `'..redis:scard(Spider..'group:ids')..'`  ➼' 
end

if MsgText[1] == "المشتركين" or MsgText[1] == "المشتركين Ⓜ" then
if not msg.SudoUser then return "❍ **هذا الامر يخص {المطور} فقط  \n" end
return '❍ **عدد المشتركين في البوت : `'..redis:scard(Spider..'users')..'` \n'
end
...
if not msg.SudoUser then return "❍ **هذا الامر يخص {المطور} فقط  \n" end
if redis:sismember(Spider..'group:ids',MsgText[2]) then
local name_gp = redis:get(Spider..'group:name'..MsgText[2])
...
return redis:get(Spider..":TEXT_SUDO") or '❍ لا توجد كليشه المطور .\n❍ يمكنك اضافه كليشه من خلال الامر\n       " `ضع كليشه المطور` " \n'
end

if MsgText[1] == "اذاعه عام بالتوجيه" or MsgText[1] == "اذاعه عام بالتوجيه 📣" then
if not msg.SudoUser then return"❍ **هذا الامر يخص {المطور} فقط  \n" end
if not msg.SudoBase and not redis:get(Spider..'lock_brod') then 
return "❍ ** الاذاعه مقفوله من قبل المطور الاساسي  ." 
end
redis:setex(Spider..'fwd:'..msg.sender_user_id_,300, true) 
...
redis:setex(Spider..'fwd:all'..msg.sender_user_id_,300, true) 
...
redis:setex(Spider..'fwd:pv'..msg.sender_user_id_,300, true) 
...
redis:setex(Spider..'fwd:groups'..msg.sender_user_id_,300, true) 
...
if not msg.Admin then return "❍ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
redis:del(Spider..'welcom:witting'..msg.sender_user_id_,
Spider..'rulse:witting'..msg.sender_user_id_,
Spider..'rulse:witting'..msg.sender_user_id_,
Spider..'name:witting'..msg.sender_user_id_,
Spider..'about:witting'..msg.sender_user_id_,
Spider..'fwd:all'..msg.sender_user_id_,
Spider..'fwd:pv'..msg.sender_user_id_,
Spider..'fwd:groups'..msg.sender_user_id_,
Spider..'namebot:witting'..msg.sender_user_id_,
Spider..'addrd_all:'..msg.sender_user_id_,
Spider..'delrd:'..msg.sender_user_id_,
Spider..'addrd:'..msg.sender_user_id_,
Spider..'delrdall:'..msg.sender_user_id_,
Spider..'text_sudo:witting'..msg.sender_user_id_,
Spider..'addrd:'..msg.chat_id_..msg.sender_user_id_,
Spider..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
...
redis:set(Spider..":VERSION",GetVerison)
return false
else
...
return '❍ اصدار سورس اسبايدر : *v'..version..'* \n'
end
...
sendMsg(msg.chat_id_,msg.id_,'❍ ** عذراً اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس اسبايدر يرجاء جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n')
end  
else
...
local inline = {{{text="-قنآهہ‏‏ آلسـورس اضـغـط هـنـآ ",url="https://t.me/SouRce_Spider"}}}
send_key(msg.sender_user_id_,'   [قناة سورس : اسبايدر](https://t.me/SouRce_Spider)' ,nil,inline,msg.id_)
return false
end
...
if MsgText[1]== "المطور يسري" and msg.type == "pv" then
local inline = {{{text="-مطور السورس اضـغـط هـنـآ ",url="https://t.me/youssry_hack"}}}
send_key(msg.sender_user_id_,'   [مطور السورس](https://t.me/youssry_hack)' ,nil,inline,msg.id_)
return false
end

if (MsgText[1]== "الاحصائيات 💥" or MsgText[1]=="الاحصائيات") then
if not msg.SudoBase then return"❍ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
return '❍ الاحصائيات . \n\n❍ **عدد المجموعات المفعله : '..redis:scard(Spider..'group:ids')..'\n❍ **عدد المشتركين في البوت : '..redis:scard(Spider..'users')..'\n'
end
---------------[End Function data] -----------------------
if MsgText[1]=="اضف رد عام" or MsgText[1]=="اضف رد عام ➕" then
if not msg.SudoBase then return"❍ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:setex(Spider..'addrd_all:'..msg.chat_id_..msg.sender_user_id_,300,true)
redis:del(Spider..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
...
if not msg.Director then return "❍ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local names 	= redis:exists(Spider..'replay:'..msg.chat_id_)
local photo 	= redis:exists(Spider..'replay_photo:group:'..msg.chat_id_)
local voice 	= redis:exists(Spider..'replay_voice:group:'..msg.chat_id_)
local imation   = redis:exists(Spider..'replay_animation:group:'..msg.chat_id_)
local audio	 	= redis:exists(Spider..'replay_audio:group:'..msg.chat_id_)
local sticker 	= redis:exists(Spider..'replay_sticker:group:'..msg.chat_id_)
local video 	= redis:exists(Spider..'replay_video:group:'..msg.chat_id_)
if names or photo or voice or imation or audio or sticker or video then
redis:del(Spider..'replay:'..msg.chat_id_,Spider..'replay_photo:group:'..msg.chat_id_,Spider..'replay_voice:group:'..msg.chat_id_,
Spider..'replay_animation:group:'..msg.chat_id_,Spider..'replay_audio:group:'..msg.chat_id_,Spider..'replay_sticker:group:'..msg.chat_id_,Spider..'replay_video:group:'..msg.chat_id_)
...
local names 	= redis:exists(Spider..'replay:all')
local photo 	= redis:exists(Spider..'replay_photo:group:')
local voice 	= redis:exists(Spider..'replay_voice:group:')
local imation 	= redis:exists(Spider..'replay_animation:group:')
local audio 	= redis:exists(Spider..'replay_audio:group:')
local sticker 	= redis:exists(Spider..'replay_sticker:group:')
local video 	= redis:exists(Spider..'replay_video:group:')
if names or photo or voice or imation or audio or sticker or video then
redis:del(Spider..'replay:all',Spider..'replay_photo:group:',Spider..'replay_voice:group:',Spider..'replay_animation:group:',Spider..'replay_audio:group:',Spider..'replay_sticker:group:',Spider..'replay_video:group:')
...
if not msg.SudoBase then return"❍ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:set(Spider..'delrdall:'..msg.sender_user_id_,true) 
return "❍ حسننا عزيزي  .\n❍ الان ارسل الرد لمسحها من  المجموعات ."
end

if MsgText[1]== 'مسح' and MsgText[2]== 'رد' then
if not msg.Director then return "❍ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
redis:set(Spider..'delrd:'..msg.sender_user_id_,true)
return "❍ حسننا عزيزي  .\n❍ الان ارسل الرد لمسحها من  للمجموعه ."
end

if MsgText[1]== 'الردود' then
if not msg.Director then return "❍ *│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local names  	= redis:hkeys(Spider..'replay:'..msg.chat_id_)
local photo 	= redis:hkeys(Spider..'replay_photo:group:'..msg.chat_id_)
local voice  	= redis:hkeys(Spider..'replay_voice:group:'..msg.chat_id_)
local imation 	= redis:hkeys(Spider..'replay_animation:group:'..msg.chat_id_)
local audio 	= redis:hkeys(Spider..'replay_audio:group:'..msg.chat_id_)
local sticker 	= redis:hkeys(Spider..'replay_sticker:group:'..msg.chat_id_)
local video 	= redis:hkeys(Spider..'replay_video:group:'..msg.chat_id_)
...
local names 	= redis:hkeys(Spider..'replay:all')
local photo 	= redis:hkeys(Spider..'replay_photo:group:')
local voice 	= redis:hkeys(Spider..'replay_voice:group:')
local imation 	= redis:hkeys(Spider..'replay_animation:group:')
local audio 	= redis:hkeys(Spider..'replay_audio:group:')
local sticker 	= redis:hkeys(Spider..'replay_sticker:group:')
local video 	= redis:hkeys(Spider..'replay_video:group:')
if #names==0 and #photo==0 and #voice==0 and #imation==0 and #audio==0 and #sticker==0 and #video==0 then 
return '❍ **لا يوجد ردود مضافه حاليا \n' 
end
local ii = 1
...
if not msg.Director then return "❍ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
redis:setex(Spider..'addrd:'..msg.chat_id_..msg.sender_user_id_,300,true) 
redis:del(Spider..'replay1'..msg.chat_id_..msg.sender_user_id_)
return "❍ حسننا , الان ارسل كلمه الرد \n"
end

if MsgText[1] == "ضع اسم للبوت" or MsgText[1]== 'ضع اسم للبوت ©' then
if not msg.SudoBase then return"❍ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:setex(Spider..'namebot:witting'..msg.sender_user_id_,300,true)
...
if not msg.Admin then return "❍ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n❍ " end
if not redis:get(Spider..'lave_me'..msg.chat_id_) then 
return "❍ **أهلا عزيزي "..msg.TheRankCmd.."\n❍ ** المغادره بالتاكيد تم تفعيلها\n✓" 
else 
redis:del(Spider..'lave_me'..msg.chat_id_) 
return "❍ **أهلا عزيزي "..msg.TheRankCmd.."\n❍ ** تم تفعيل المغادره \n✓" 
end 
end
if MsgText[1] == "تعطيل" and MsgText[2] == "اطردني" then
if not msg.Admin then return "❍ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n❍ " end
if redis:get(Spider..'lave_me'..msg.chat_id_) then 
return "❍ **أهلا عزيزي "..msg.TheRankCmd.."\n❍ ** المغادره من قبل البوت بالتأكيد معطله\n✓" 
else
redis:set(Spider..'lave_me'..msg.chat_id_,true)  
...
❍ 𝐷𝐸𝑉 >> [˹ 𝐽𝐴𝐶𝐾 .](t.me/V_P_E)
ــــــــــــــــــــــ❍ـــــــــــــــــــــ 
❍ 𝐷𝐸𝑉 >> [˹ 𝐸𝐿 𝐽𝑂𝐾𝐸𝑅 .](t.me/youssry_hack)
ــــــــــــــــــــــ❍ـــــــــــــــــــــ
❍ـــ❍ >> [˹ 𝑆𝑂𝑈𝑅𝐶𝐸 𝐵𝐿𝐴𝐶𝐾 .](t.me/SouRce_Spider)
ــــــــــــــــــــــ❍ـــــــــــــــــــــ
...
if not msg.SudoBase then return"❍ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
local SubDel = redis:del(Spider..":UserNameChaneel")
if SubDel == 1 then
...
if not msg.SudoBase then return"❍ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
local UserChaneel = redis:get(Spider..":UserNameChaneel")
if UserChaneel then
...
if redis:get(Spider..'welc'..msg.chat_id_) == 'on' then
...
local hash = Spider..'user_names:'..msg.sender_user_id_
redis:set(hash,info)
end
...
function setadmins(Spider,diamond)
...
function remadmins(Spider,diamond)
...
mmd = redis:get(Spider..'addcmd'..msg.chat_id_..msg.sender_user_id_)
if mmd then
redis:sadd(Spider..'CmDlist:'..msg.chat_id_,msg.text)
redis:hset(Spider..'CmD:'..msg.chat_id_,msg.text,mmd)
sendMsg(msg.chat_id_,msg.id_,'❍ اهلا عزيزي \n❍ تم تثبيت الامر الجديد\n✓')
redis:del(Spider..'addcmd'..msg.chat_id_..msg.sender_user_id_)
end

if Black:match('تغير امر (.*)') then
if not msg.Kara then return "❍ **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
local cmd = Black:match('تغير امر (.*)') 
redis:setex(Spider..'addcmd'..msg.chat_id_..msg.sender_user_id_,120,cmd)
...
redis:hdel(Spider..'CmD:'..msg.chat_id_,cmd)
redis:srem(Spider..'CmDlist:'..msg.chat_id_,cmd)
sendMsg(msg.chat_id_,msg.id_,"❍ اهلا عزيزي\nالامر >"..cmd.."\n❍ تم مسحه من قائمه الاوامر\n")
end
if Black == 'مسح قائمه الاوامر' or Black == 'مسح قائمه الاوامر' then
if not msg.Kara then return "❍ **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
redis:del(Spider..'CmD:'..msg.chat_id_)
redis:del(Spider..'CmDlist:'..msg.chat_id_)
sendMsg(msg.chat_id_,msg.id_,"❍ اهلا عزيزي تم مسح قائمه الاوامر")
end
if Black == "قائمه الاوامر" then
if not msg.Kara then return "❍ **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
local CmDlist = redis:smembers(Spider..'CmDlist:'..msg.chat_id_)
local t = '❍ قائمه الاوامر : \n'
for k,v in pairs(CmDlist) do
mmdi = redis:hget(Spider..'CmD:'..msg.chat_id_,v)
t = t..k..") "..v.." > "..mmdi.."\n" 
end
if #CmDlist == 0 then
...
redis:set(Spider..'welc'..msg.chat_id_,'on')
end
end
if Text == 'welcome off' or Text == 'تعطيل الترحيب' then
if redis:get(Spider..'welc'..msg.chat_id_) == 'off' then
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل الترحيب سابقا')
redis:set(Spider..'welc'..msg.chat_id_,'off')
redis:del(Spider..'welc'..msg.chat_id_,'on')
else
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل الترحيب')
end
end

if Black == 'welcome on' or Black == 'الشبكه العنكبوتيه' then
if redis:get(Spider..'welc'..msg.chat_id_) == 'on' then
sendMsg(msg.chat_id_,msg.id_,'تم الشبكه العنكبوتيه سابقا')
else
sendMsg(msg.chat_id_,msg.id_,'تم الشبكه العنكبوتيه')
redis:set(Spider..'welc'..msg.chat_id_,'on')
end
end
if Text == 'welcome off' or Text == 'تعطيل الشبكه العنكبوتيه' then
if redis:get(Spider..'welc'..msg.chat_id_) == 'off' then
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل الشبكه العنكبوتيه سابقا')
redis:set(Spider..'welc'..msg.chat_id_,'off')
redis:del(Spider..'welc'..msg.chat_id_,'on')
else
sendMsg(msg.chat_id_,msg.id_,'تم الشبكه العنكبوتيه الترحيب')
end
end


if Text == "join on" and msg.SudoUser then
redis:set(Spider..'joinchnl',true)
sendMsg(msg.chat_id_,msg.id_,'on')
end
if Text and redis:get(Spider..'setchs') and msg.SudoUser then
redis:set(Spider..'setch',Text)
sendMsg(msg.chat_id_,msg.id_,'تم تعين القناه علي \n'..Text)
redis:del(Spider..'setchs')
end
if Text and (Text:match("^setch$")) and msg.SudoUser then
sendMsg(msg.chat_id_,msg.id_,'ارسل معرفك بدون @')
redis:setex(Spider..'setchs',120,true)
end
...
function tophoto(kara,Spider)   
if Spider.content_.ID == "MessageSticker" then        
local bd = Spider.content_.sticker_.sticker_.path_          
...
local msg_pv = tonumber(redis:get(Spider..'user:'..msg.sender_user_id_..':msgs') or 0)
if msg_pv > 5 then
redis:setex(Spider..':mute_pv:'..msg.sender_user_id_,18000,true)   
return sendMsg(msg.chat_id_,0,'*❍ * تم حظرك من البوت بسبب التكرار \n') 
end
redis:setex(Spider..'user:'..msg.sender_user_id_..':msgs',2,msg_pv+1)
end

if msg.text=="/start" then 

if msg.SudoBase then
local text = '- شكراً لك لإستخدام سورس اسبايدر\n- أنت المطور الاساسي هنا\n—————————\n\n- يمكنك الأن التحكم بأوامر البوت عن طريق لوحة التحكم بالبوت\nفقط انقر على الأمر الذي اريده‏'
local keyboard = {
{"المطور يسري","المبرمج جاك"},
{"ضع اسم للبوت","ضع صوره للترحيب"},
{"الشبكه العنكبوتيه","تعطيل الشبكه العنكبوتيه"},
...
redis:sadd(Spider..'users',msg.sender_user_id_)
if redis:get(Spider..'lock_service') then 
text = [[❍ أهلاً انا بوت   []]..redis:get(Spider..':NameBot:')..[[] 🗽
...
local MSG_ID = (redis:get(Spider.."USER_MSG_TWASEL"..FwdDate) or 1)
if msg.text then
...
if not redis:get(Spider..'lock_twasel') then
...
redis:setex(Spider.."USER_MSG_TWASEL"..msg.date_,43200,msg.id_)
...
--====================== Reply Only Group ====================================
if redis:get(Spider..'addrd:'..msg.chat_id_..msg.sender_user_id_) and redis:get(Spider..'replay1'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(Spider..'replay1'..msg.chat_id_..msg.sender_user_id_)
if msg.text then 
redis:hset(Spider..'replay:'..msg.chat_id_,klma,Flter_Markdown(msg.text))
redis:del(Spider..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'(['..klma..'])\n❍ تم اضافت الرد . \n-')
elseif msg.photo then 
redis:hset(Spider..'replay_photo:group:'..msg.chat_id_,klma,photo_id)
redis:del(Spider..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'❍ تم اضافه صوره للرد بنجاح\n❍ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.voice then
redis:hset(Spider..'replay_voice:group:'..msg.chat_id_,klma,voice_id)
redis:del(Spider..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'❍ تم اضافه بصمه صوت للرد بنجاح\n❍ يمكنك ارسال ❴ ['..klma..'] ❵ لسماع البصمه الاتيه ')
elseif msg.animation then
redis:hset(Spider..'replay_animation:group:'..msg.chat_id_,klma,animation_id)
redis:del(Spider..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'❍ تم اضافه متحركه للرد بنجاح\n❍ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.video then
redis:hset(Spider..'replay_video:group:'..msg.chat_id_,klma,video_id)
redis:del(Spider..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'❍ تم اضافه فيديو للرد بنجاح\n❍ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الفيديو الاتي ')
elseif msg.audio then
redis:hset(Spider..'replay_audio:group:'..msg.chat_id_,klma,audio_id)
redis:del(Spider..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'❍ تم اضافه للصوت للرد بنجاح\n❍ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوت الاتي ')
elseif msg.sticker then
redis:hset(Spider..'replay_sticker:group:'..msg.chat_id_,klma,sticker_id)
redis:del(Spider..'addrd:'..msg.chat_id_..msg.sender_user_id_)
...
--====================== Reply All Groups =====================================
if redis:get(Spider..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) and redis:get(Spider..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(Spider..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
if msg.text then
redis:hset(Spider..'replay:all',klma,Flter_Markdown(msg.text))
redis:del(Spider..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'(['..klma..'])\n  ❍ تم اضافت الرد لكل المجموعات . ')
elseif msg.photo then 
redis:hset(Spider..'replay_photo:group:',klma,photo_id)
redis:del(Spider..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'❍ تم اضافه صوره للرد العام\n❍ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.voice then
redis:hset(Spider..'replay_voice:group:',klma,voice_id)
redis:del(Spider..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'❍ تم اضافه بصمه صوت للرد العام\n❍ يمكنك ارسال ❴ ['..klma..'] ❵ لسماع البصمه الاتيه ')
elseif msg.animation then
redis:hset(Spider..'replay_animation:group:',klma,animation_id)
redis:del(Spider..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'❍ تم اضافه متحركه للرد العام\n❍ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.video then
redis:hset(Spider..'replay_video:group:',klma,video_id)
redis:del(Spider..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'❍ تم اضافه فيديو للرد العام\n❍ يمكنك ارسال ❴ ['..klma..'] ❵لأظهار الفيديو الاتي ')
elseif msg.audio then
redis:hset(Spider..'replay_audio:group:',klma,audio_id)
redis:del(Spider..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'❍ تم اضافه للصوت للرد العام\n❍ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوت الاتي ')
elseif msg.sticker then
redis:hset(Spider..'replay_sticker:group:',klma,sticker_id)
redis:del(Spider..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
...
if redis:get(Spider..":ForceSub:"..msg.sender_user_id_) then
if msg.text:match("^@[%a%d_]+$") then
redis:del(Spider..":ForceSub:"..msg.sender_user_id_)
...
redis:set(Spider..":UserNameChaneel",msg.text)
...
if redis:get(Spider..'namebot:witting'..msg.sender_user_id_) then --- استقبال اسم البوت 
redis:del(Spider..'namebot:witting'..msg.sender_user_id_)
redis:set(Spider..':NameBot:',msg.text)
Start_Bot() 
sendMsg(msg.chat_id_,msg.id_,"❍ تم تغير اسم البوت  .\n❍ الان اسمه "..Flter_Markdown(msg.text).." \n")
return false
end

if redis:get(Spider..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد لكل المجموعات
if not redis:get(Spider..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال كلمه الرد لكل المجموعات
redis:hdel(Spider..'replay_photo:group:',msg.text)
redis:hdel(Spider..'replay_voice:group:',msg.text)
redis:hdel(Spider..'replay_animation:group:',msg.text)
redis:hdel(Spider..'replay_audio:group:',msg.text)
redis:hdel(Spider..'replay_sticker:group:',msg.text)
redis:hdel(Spider..'replay_video:group:',msg.text)
redis:setex(Spider..'allreplay:'..msg.chat_id_..msg.sender_user_id_,300,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"❍ جيد , يمكنك الان ارسال جوا ب الردالعام \n❍ [[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]]\n")
end
end

if redis:get(Spider..'delrdall:'..msg.sender_user_id_) then
redis:del(Spider..'delrdall:'..msg.sender_user_id_)
local names = redis:hget(Spider..'replay:all',msg.text)
local photo =redis:hget(Spider..'replay_photo:group:',msg.text)
local voice = redis:hget(Spider..'replay_voice:group:',msg.text)
local animation = redis:hget(Spider..'replay_animation:group:',msg.text)
local audio = redis:hget(Spider..'replay_audio:group:',msg.text)
local sticker = redis:hget(Spider..'replay_sticker:group:',msg.text)
local video = redis:hget(Spider..'replay_video:group:',msg.text)
if not (names or photo or voice or animation or audio or sticker or video) then
return sendMsg(msg.chat_id_,msg.id_,'❍ **هذا الرد ليس مضاف في قائمه الردود .')
else
redis:hdel(Spider..'replay:all',msg.text)
redis:hdel(Spider..'replay_photo:group:',msg.text)
redis:hdel(Spider..'replay_voice:group:',msg.text)
redis:hdel(Spider..'replay_audio:group:',msg.text)
redis:hdel(Spider..'replay_animation:group:',msg.text)
...
if redis:get(Spider..'text_sudo:witting'..msg.sender_user_id_) then -- استقبال كليشه المطور
redis:del(Spider..'text_sudo:witting'..msg.sender_user_id_) 
redis:set(Spider..':TEXT_SUDO',Flter_Markdown(msg.text))
return sendMsg(msg.chat_id_,msg.id_, "❍ ** تم وضع الكليشه بنجاح كلاتي .\n\n*{*  "..Flter_Markdown(msg.text).."  *}*\n")
end
if redis:get(Spider..'welcom:witting'..msg.sender_user_id_) then -- استقبال كليشه الترحيب
redis:del(Spider..'welcom:witting'..msg.sender_user_id_) 
redis:set(Spider..'welcome:msg'..msg.chat_id_,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"❍ ** تم وضع الترحيب بنجاح كلاتي .\n" )
end
if redis:get(Spider..'rulse:witting'..msg.sender_user_id_) then --- استقبال القوانين
redis:del(Spider..'rulse:witting'..msg.sender_user_id_) 
redis:set(Spider..'rulse:msg'..msg.chat_id_,Flter_Markdown(msg.text)) 
return sendMsg(msg.chat_id_,msg.id_,'❍ ** مرحبآ عزيزي\n❍ تم حفظ القوانين بنجاح .\n❍ ارسل [[ القوانين ]] لعرضها \n')
end
if redis:get(Spider..'name:witting'..msg.sender_user_id_) then --- استقبال الاسم
redis:del(Spider..'name:witting'..msg.sender_user_id_) 
tdcli_function({ID= "ChangeChatTitle",chat_id_=msg.chat_id_,title_=msg.text},dl_cb,nil)
end
if redis:get(Spider..'linkGroup'..msg.sender_user_id_,link) then --- استقبال الرابط
redis:del(Spider..'linkGroup'..msg.sender_user_id_,link) 
redis:set(Spider..'linkGroup'..msg.chat_id_,Flter_Markdown(msg.text)) 
return sendMsg(msg.chat_id_,msg.id_,'❍ تم وضع الرابط الجديد بنجاح .. 🍂')
end
if redis:get(Spider..'about:witting'..msg.sender_user_id_) then --- استقبال الوصف
redis:del(Spider..'about:witting'..msg.sender_user_id_) 
...
if redis:get(Spider..'fwd:all'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه عام
redis:del(Spider..'fwd:all'..msg.sender_user_id_)
local pv = redis:smembers(Spider..'users')  
local groups = redis:smembers(Spider..'group:ids')
...
if redis:get(Spider..'fwd:pv'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
redis:del(Spider..'fwd:pv'..msg.sender_user_id_)
local pv = redis:smembers(Spider..'users')
if #pv >= 300 then
...
if redis:get(Spider..'fwd:groups'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
redis:del(Spider..'fwd:groups'..msg.sender_user_id_)
local groups = redis:smembers(Spider..'group:ids')
if #groups >= 300 then
...
if msg.adduser and msg.adduser == our_id and redis:get(Spider..':WELCOME_BOT') then
sendPhoto(msg.chat_id_,msg.id_,redis:get(Spider..':WELCOME_BOT'),[[❍أهلاً انا بوت ]]..redis:get(Spider..':NameBot:')..[[
❍ أختصاصي حماية‌‏ المجموعات
❍ مـن السبام والتوجيه‌‏ والتكرار والخ...
...
if msg.forward_info and redis:get(Spider..'fwd:'..msg.sender_user_id_) then
redis:del(Spider..'fwd:'..msg.sender_user_id_)
local pv = redis:smembers(Spider..'users')
local groups = redis:smembers(Spider..'group:ids')
local allgp =  #pv + #groups
if allgp == 500 then
...
if msg.content_.ID == "MessagePhoto" and redis:get(Spider..'welcom_ph:witting'..msg.sender_user_id_) then
redis:del(Spider..'welcom_ph:witting'..msg.sender_user_id_)
if msg.content_.photo_.sizes_[3] then 
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_
else 
photo_id = msg.content_.photo_.sizes_[0].photo_.persistent_id_
end
redis:set(Spider..':WELCOME_BOT',photo_id)
return sendMsg(msg.chat_id_,msg.id_,'❍ تم تغيير صوره‏‏ الترحيب للبوت .\n')
end 

if msg.content_.ID == "MessagePhoto" and msg.type == "channel" and msg.GroupActive then
if redis:get(Spider..'photo:group'..msg.chat_id_..msg.sender_user_id_) then
redis:del(Spider..'photo:group'..msg.chat_id_..msg.sender_user_id_)
if msg.content_.photo_.sizes_[3] then 
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_
else 
photo_id = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
if redis:get(Spider..'addrd:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد للمجموعه فقط

if not redis:get(Spider..'replay1'..msg.chat_id_..msg.sender_user_id_) then  -- كلمه الرد
redis:hdel(Spider..'replay:'..msg.chat_id_,msg.text)
redis:hdel(Spider..'replay_photo:group:'..msg.chat_id_,msg.text)
redis:hdel(Spider..'replay_voice:group:'..msg.chat_id_,msg.text)
redis:hdel(Spider..'replay_animation:group:'..msg.chat_id_,msg.text)
redis:hdel(Spider..'replay_audio:group:'..msg.chat_id_,msg.text)
redis:hdel(Spider..'replay_sticker:group:'..msg.chat_id_,msg.text)
redis:hdel(Spider..'replay_video:group:'..msg.chat_id_,msg.text)
redis:setex(Spider..'replay1'..msg.chat_id_..msg.sender_user_id_,300,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"❍ جيد , يمكنك الان ارسال جواب الرد \n❍ [[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]]\n")
end
end

if redis:get(Spider..'delrd:'..msg.sender_user_id_) then
redis:del(Spider..'delrd:'..msg.sender_user_id_)
local names 	= redis:hget(Spider..'replay:'..msg.chat_id_,msg.text)
local photo 	= redis:hget(Spider..'replay_photo:group:'..msg.chat_id_,msg.text)
local voice 	= redis:hget(Spider..'replay_voice:group:'..msg.chat_id_,msg.text)
local animation = redis:hget(Spider..'replay_animation:group:'..msg.chat_id_,msg.text)
local audio 	= redis:hget(Spider..'replay_audio:group:'..msg.chat_id_,msg.text)
local sticker 	= redis:hget(Spider..'replay_sticker:group:'..msg.chat_id_,msg.text)
local video 	= redis:hget(Spider..'replay_video:group:'..msg.chat_id_,msg.text)
if not (names or photo or voice or animation or audio or sticker or video) then
return sendMsg(msg.chat_id_,msg.id_,'❍ **هذا الرد ليس مضاف في قائمه الردود .')
else
redis:hdel(Spider..'replay:'..msg.chat_id_,msg.text)
...
if msg.pinned then
print(" -- pinned -- ")
local msg_pin_id = redis:get(Spider..":MsgIDPin:"..msg.chat_id_)
if not msg.Director and redis:get(Spider..'lock_pin'..msg.chat_id_) then
if msg_pin_id then
...
redis:set(Spider..":MsgIDPin:"..msg.chat_id_,msg.id_)
end
...
GetUserID(msg.sender_user_id_,function(arg,data)
redis:set(Spider..'group:name'..msg.chat_id_,msg.content_.title_)
if data.username_ then UserName = "@"..data.username_ else UserName = "احد المشرفين" end
...
if redis:get(Spider..'mute_tgservice'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_)
else
if redis:get(Spider..'welcome:get'..msg.chat_id_) then 
if not msg.adduserType then
GetUserID(msg.sender_user_id_,function(arg,data)  
welcome = (redis:get(Spider..'welcome:msg'..msg.chat_id_) or "❍ اهلاً عزيزي {الاسم}\n❍ معرفك » {المعرف}\n{القوانين}\n\nالرجاء الالتزام بالقوانين\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n❍ اسم القروب » {المجموعه}")
if welcome then
rules = (redis:get(Spider..'rulse:msg'..msg.chat_id_) or "❍ مرحباً عزيري القوانين كلاتي .\n❍ ممنوع نشر الروابط\n❍ ممنوع التكلم او نشر صور اباحيه\n❍ ممنوع  اعاده توجيه\n❍ ممنوع التكلم بالسياسة\n❍ الرجاء احترام المدراء والادمنيه .\n")
welcome = welcome:gsub("{القوانين}", rules)
if data.username_ then UserName = '@'..data.username_ else UserName = '< لا يوجد معرف >' end
welcome = welcome:gsub("{المجموعه}",Flter_Markdown((redis:get(Spider..'group:name'..msg.chat_id_) or '')))
...
welcome = (redis:get(Spider..'welcome:msg'..msg.chat_id_) or "❍ اهلن بك عزيزي {الاسم}\n❍ معرفك » {المعرف}\n{القوانين}\n\nالرجاء الالتزام بالقوانين\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n❍ اسم القروب » {المجموعه}")
if welcome then
rules = (redis:get(Spider..'rulse:msg'..msg.chat_id_) or "❍ مرحباً عزيري القوانين كلاتي .\n❍ ممنوع نشر الروابط\n❍ ممنوع التكلم او نشر صور اباحيه\n❍ ممنوع  اعاده توجيه\n❍ ممنوع التكلم بالسياسة\n❍ الرجاء احترام المدراء والادمنيه\n")
welcome = welcome:gsub("{القوانين}", rules)
...
--------------------------------------------
if msg.adduser and redis:get(Spider..'welcome:get'..msg.chat_id_) then
local adduserx = tonumber(redis:get(Spider..'user:'..msg.sender_user_id_..':msgs') or 0)
if adduserx > 3 then 
redis:del(Spider..'welcome:get'..msg.chat_id_)
end
redis:setex(Spider..'user:'..msg.sender_user_id_..':msgs',3,adduserx+1)
end

if not msg.Admin and not msg.Special and not (msg.adduser or msg.joinuser or msg.deluser ) then -- للاعضاء فقط   

if not msg.forward_info and redis:get(Spider..'lock_flood'..msg.chat_id_)  then
local msgs = (redis:get(Spider..'user:'..msg.sender_user_id_..':msgs') or 0)
local NUM_MSG_Spider = (redis:get(Spider..'num_msg_Spider'..msg.chat_id_) or 5)
if tonumber(msgs) > tonumber(NUM_MSG_Spider) then 
GetUserID(msg.sender_user_id_,function(arg,datau)
Restrict(msg.chat_id_,msg.sender_user_id_,1)
redis:setex(Spider..'sender:'..msg.sender_user_id_..':flood',30,true)
if datau.username_ then USERNAME = '@'..datau.username_ else USERNAME = FlterName(datau.first_name_..' '..(datau.last_name_ or "")) end
local USERCAR = utf8.len(USERNAME)
SendMention(msg.chat_id_,datau.id_,msg.id_,"❍ العضو » "..USERNAME.."\n❍ قمـت بتكرار اكثر مـن "..NUM_MSG_Spider.." رسالة‌‏ , لذا تم تقييدك مـن المجموعه‌\n",12,USERCAR) 
return false
end)
end 
redis:setex(Spider..'user:'..msg.sender_user_id_..':msgs',2,msgs+1)
end
...
if redis:get(Spider..'mute_forward'..msg.chat_id_) then -- قفل التوجيه
...
if redis:get(Spider..'lock_woring'..msg.chat_id_) and not redis:get(Spider..':User_Fwd_Msg:'..msg.sender_user_id_..':flood') then
GetUserID(msg.sender_user_id_,function(arg,data)
...
return redis:setex(Spider..':User_Fwd_Msg:'..msg.sender_user_id_..':flood',15,true)
end,nil)
end
end)
return false
elseif redis:get(Spider..':tqeed_fwd:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif tonumber(msg.via_bot_user_id_) ~= 0 and redis:get(Spider..'mute_inline'..msg.chat_id_) then -- قفل الانلاين
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
print("\27[1;31m Msg Del becuse send inline \27[0m")
if data.ID == "Error" and data.code_ == 6 then
return sendMsg(msg.chat_id_,msg.id_,'❍ ** لا يمكنني مسح الرساله المخالفه .\n❍ ** لست مشرف او ليس لدي صلاحيه  الحذف \n')    
end
if redis:get(Spider..'lock_woring'..msg.chat_id_) then
GetUserID(msg.sender_user_id_,function(arg,data)
...
if utf8.len(msg.text) > 500 and redis:get(Spider..'lock_spam'..msg.chat_id_) then -- قفل الكليشه 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(Spider..':tqeed_link:'..msg.chat_id_)  then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(Spider..'lock_link'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif (msg.text:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.text:match("[Hh][Tt][Tt][Pp]://") or msg.text:match("[Ww][Ww][Ww].") or msg.text:match(".[Cc][Oo][Mm]") or msg.text:match(".[Tt][Kk]") or msg.text:match(".[Mm][Ll]") or msg.text:match(".[Oo][Rr][Gg]")) and redis:get(Spider..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("#[%a%d_]+") and redis:get(Spider..'lock_tag'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("@[%a%d_]+")  and redis:get(Spider..'lock_username'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif not msg.textEntityTypeBold and (msg.textEntityTypeBold or msg.textEntityTypeItalic) and redis:get(Spider..'lock_markdown'..msg.chat_id_) then 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.textEntityTypeTextUrl and redis:get(Spider..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.edited and redis:get(Spider..'lock_edit'..msg.chat_id_) then -- قفل التعديل
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.content_.ID == "MessageUnsupported" and redis:get(Spider..'mute_video'..msg.chat_id_) then -- قفل الفيديو
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.photo then
if redis:get(Spider..'mute_photo'..msg.chat_id_)  then -- قفل الصور
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(Spider..':tqeed_photo:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.video then
if redis:get(Spider..'mute_video'..msg.chat_id_) then -- قفل الفيديو
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(Spider..':tqeed_video:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.document and redis:get(Spider..'mute_document'..msg.chat_id_) then -- قفل الملفات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.sticker and redis:get(Spider..'mute_sticker'..msg.chat_id_) then --قفل الملصقات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.animation then
if redis:get(Spider..'mute_gif'..msg.chat_id_) then -- قفل المتحركه
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(Spider..':tqeed_gif:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.contact and redis:get(Spider..'mute_contact'..msg.chat_id_) then -- قفل الجهات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.location and redis:get(Spider..'mute_location'..msg.chat_id_) then -- قفل الموقع
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.voice and redis:get(Spider..'mute_voice'..msg.chat_id_) then -- قفل البصمات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.game and redis:get(Spider..'mute_game'..msg.chat_id_) then -- قفل الالعاب
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.audio and redis:get(Spider..'mute_audio'..msg.chat_id_) then -- قفل الصوت
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.replyMarkupInlineKeyboard and redis:get(Spider..'mute_keyboard'..msg.chat_id_) then -- كيبورد
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(Spider..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.caption_:match("@[%a%d_]+") and redis:get(Spider..'lock_username'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
if msg.text and redis:get(Spider..'replay'..msg.chat_id_) then

local Replay = false

 Replay = redis:hget(Spider..'replay:all',msg.text)
if Replay then
sendMsg(msg.chat_id_,msg.id_,Replay)
return false
end

 Replay = redis:hget(Spider..'replay:'..msg.chat_id_,msg.text)
if Replay then 
 sendMsg(msg.chat_id_,msg.id_,Replay) 
return false
end
 Replay = redis:hget(Spider..'replay_photo:group:',msg.text)
if Replay then 
 sendPhoto(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(Spider..'replay_voice:group:',msg.text)
if Replay then 
 sendVoice(msg.chat_id_,msg.id_,Replay)
return false
end

Replay = redis:hget(Spider..'replay_animation:group:',msg.text)
if Replay then 
 sendAnimation(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(Spider..'replay_audio:group:',msg.text)
if Replay then 
 sendAudio(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(Spider..'replay_sticker:group:',msg.text)
if Replay then 
 sendSticker(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(Spider..'replay_video:group:',msg.text)
if Replay then 
print("0000000000000") 
...
Replay = redis:hget(Spider..'replay_photo:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendPhoto(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(Spider..'replay_voice:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendVoice(msg.chat_id_,msg.id_,Replay)
return false
end

Replay = redis:hget(Spider..'replay_animation:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendAnimation(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(Spider..'replay_audio:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendAudio(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(Spider..'replay_sticker:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendSticker(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(Spider..'replay_video:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendVideo(msg.chat_id_,msg.id_,Replay)
return false
end
...
elseif Text== "جاك" or Text== "جاك" then return  sendMsg(msg.chat_id_,msg.id_,"[مطور سورس بلاك واسبايدر](https://t.me/V_P_E)")
elseif Text== "يسري" or Text== "يسري" then return  sendMsg(msg.chat_id_,msg.id_,"[مطور سورس اسبايدر ↯](https://t.me/youssry_hack)")
elseif Text== "ديكابريو" or Text== " ديكابريو" then return  sendMsg(msg.chat_id_,msg.id_,"[مطور سورس اسبايدر ↯](https://t.me/D_i_c_a_p_r_i_o1)")
elseif Text== "سورس اسبايدر" or Text== "سورس اسبايدر" then return  sendMsg(msg.chat_id_,msg.id_,"[احسن سورس مصري ↯](https://t.me/SouRce_Spider)")
...
elseif Text== "رفع الشبكه العنكبوتيه"  then return sendMsg(msg.chat_id_,msg.id_,"❍ آههلآ  عـزيزي\n❍ لقد تم رفع اسبايدر بنجاح \n❍ اديلو اسبايدر\n")
elseif Text== "تنزيل الشبكه العنكبوتيه"  then return sendMsg(msg.chat_id_,msg.id_,"❍ آههلآ  عـزيزي\n❍ لقد تم رفع اسبايدر بنجاح \n❍ اديلو اسبايدر\n")
...
return sendMsg(msg.chat_id_,msg.id_,"[انت مطوري الغالي ♕](https://t.me/SouRce_Spider) ")
elseif msg.Creator then 
return sendMsg(msg.chat_id_,msg.id_,"[انت منشئ المجموعه  تاج راسي♔](https://t.me/SouRce_Spider)")
elseif msg.Director then 
return sendMsg(msg.chat_id_,msg.id_,"[انت مدير المجموعه๑](https://t.me/SouRce_Spider)")
elseif msg.Admin then 
return sendMsg(msg.chat_id_,msg.id_,"[انت ادمن شد حيلك♘](https://t.me/SouRce_Spider)")
else 
return sendMsg(msg.chat_id_,msg.id_,"[مجرد عضو هنا 𖦹](https://t.me/SouRce_Spider)")
end 
end 
elseif Text== "مين ضافني" or Text== "منو ضافني"  then
if msg.SudoUser then  
return sendMsg(msg.chat_id_,msg.id_,"[انت مكانك كل مكان يا مطور♕](https://t.me/SouRce_Spider) ")
elseif msg.Creator then 
return sendMsg(msg.chat_id_,msg.id_,"[انت منشئ المجموعه](https://t.me/SouRce_Spider)")
elseif msg.Director then 
return sendMsg(msg.chat_id_,msg.id_,"[انت دخلت عبر الرابط](https://t.me/SouRce_Spider)")
elseif msg.Admin then 
return sendMsg(msg.chat_id_,msg.id_,"[انت دخلت عبر الرابط](https://t.me/SouRce_Spider)")
else 
return sendMsg(msg.chat_id_,msg.id_,"[انت دخلت عبر الرابط](https://t.me/SouRce_Spider)")
...
if not redis:get('kar') then
  ...
  json_data = '{"BotID": '..Spider..',"UserBot": "'..Bot_User..'","Groups" : {'
  local All_Groups_ID = redis:smembers(Spider..'group:ids')
  for key,GroupS in pairs(All_Groups_ID) do
  local NameGroup = (redis:get(Spider..'group:name'..GroupS) or '')
  ...
  local admins = redis:smembers(Spider..'admins:'..GroupS)
  if #admins ~= 0 then
  json_data =  json_data..',"Admins" : {'
  for key,value in pairs(admins) do
  local info = redis:hgetall(Spider..'username:'..value)
  if info then 
  ...
  local creators = redis:smembers(Spider..':MONSHA_BOT:'..GroupS)
  if #creators ~= 0 then
  ...
  local creator = redis:smembers(Spider..':KARA_BOT:'..GroupS)
  if #creator ~= 0 then
  ...
  local owner = redis:smembers(Spider..'owners:'..GroupS)
  if #owner ~= 0 then
  ...
  if redis:get(Spider..'CheckExpire::'..msg.chat_id_) then
  local ExpireDate = redis:ttl(Spider..'ExpireDate:'..msg.chat_id_)
  if not ExpireDate and not msg.SudoUser then
  rem_data_group(msg.chat_id_)
  sendMsg(SUDO_ID,0,'❍ انتهى الاشتراك في احد المجموعات .\n❍ المجموعه : '..FlterName(redis:get(Spider..'group:name'..msg.chat_id_))..'.\n❍ ايدي : '..msg.chat_id_)
  sendMsg(msg.chat_id_,0,'❍ انتهى الاشتراك البوت.\n❍ سوف اغادر المجموعه فرصه سعيده .\n❍ او راسل المطور للتجديد '..SUDO_USER..' 🍃')
  return StatusLeft(msg.chat_id_,our_id)
  else
  local DaysEx = (redis:ttl(Spider..'ExpireDate:'..msg.chat_id_) / 86400)
