...
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(spider..":NameBot:")
...
var = 'مطور اساسي' 
elseif  UserID == 1407960197 then
var =  'مالك السورس'
elseif  UserID == 1424388256 then
var =  'مالك السورس'
elseif  UserID == 1377559539 then
var =  'مطور السورس'
elseif redis:sismember(spider..':SUDO_BOT:',UserID) then
var = 'مطور البوت' 
elseif redis:sismember(spider..':KARA_BOT:'..ChatID,UserID) then
var = ' المنشىء الاساسي' 
elseif redis:sismember(spider..':MONSHA_BOT:'..ChatID,UserID) then
var = ' المنشىء' 
elseif redis:sismember(spider..'owners:'..ChatID,UserID) then
var = 'مدير البوت' 
elseif redis:sismember(spider..'admins:'..ChatID,UserID) then
var = 'ادمن في البوت' 
elseif redis:sismember(spider..'whitelist:'..ChatID,UserID) then
var = 'عضو مميز' 
else
var = 'فقط عضو' 
end
...
if msg.edited then
redis:incr(spider..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.text and not msg.forward_info then
redis:incr(spider..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
elseif msg.adduser then 
redis:incr(spider..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.photo then
redis:incr(spider..':photo:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.sticker then
redis:incr(spider..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.voice then
redis:incr(spider..':voice:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.audio then
redis:incr(spider..':audio:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.video or msg.video_note then
redis:incr(spider..':video:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.animation then
redis:incr(spider..':animation:'..msg.chat_id_..':'..msg.sender_user_id_)
end
end
...
local list = redis:smembers(spider..':SUDO_BOT:')
message = '❍ ** قائمه الـمـطـوريـن : \n\n`❍ مطور اساسي`**\n'..SUDO_USER..' » ❪' ..SUDO_ID.. '❫\n*———————————————— *\n'
if #list==0 then  message = message.."* لا يوجد مطورين حاليا \n .*"
else
for k,v in pairs(list) do
local info = redis:hgetall(spider..'username:'..v)
local count = redis:scard(spider..'mtwr_count'..v)
...
local monsha = redis:smembers(spider..':MONSHA_BOT:'..msg.chat_id_)
if #monsha == 0 then 
...
message = message..'*————————— \n\n❍ قائمه المدراء :*\n\n'
local list = redis:smembers(spider..'owners:'..msg.chat_id_)
if #list == 0 then  
...
local list = redis:smembers(spider..'admins:'..msg.chat_id_)
...
local list = redis:smembers(spider..'whitelist:'..msg.chat_id_)
...
if redis:sismember(spider..'is_silent_users:'..Group,User) then 
return true 
else
return false
end 
...
local list = redis:smembers(spider..'is_silent_users:'..msg.chat_id_)
...
if redis:sismember(spider..'banned:'..Group,User) then 
return true 
else
return false
end 
...
if redis:sismember(spider..'gban_users',User) then 
return true 
else
return false
end 
...
local list = redis:smembers(spider..'gban_users')
...
local list = redis:smembers(spider..':Filter_Word:'..msg.chat_id_)
if #list ~=0 then
...
if redis:sismember(spider..':Filter_Word:'..msg.chat_id_,word) then 
return  "❍ **الكلمه *{"..word.."}* هي بالتأكيد من قائمه المنع ." 
else
redis:sadd(spider..':Filter_Word:'..msg.chat_id_,word) 
...
if redis:sismember(spider..':Filter_Word:'..msg.chat_id_,word) then 
redis:srem(spider..':Filter_Word:'..msg.chat_id_,word) 
...
EnterCmd = true
local NumberFlood = tonumber(redis:get(spider..':Flood_Spam:'..msg.sender_user_id_..':msgs') or 0)
if NumberFlood > 3 then 
redis:setex(spider..':Flood_Spam:'..msg.sender_user_id_..':Stoped',10,true)
EnterCmd = false
elseif redis:get(spider..':Flood_Spam:'..msg.sender_user_id_..':Stoped') then
EnterCmd = false
else
redis:setex(spider..':Flood_Spam:'..msg.sender_user_id_..':msgs',3,NumberFlood+1)
end
return EnterCmd
end
...
local list = redis:smembers(spider..'group:ids')
message = '❍ **قائمه المجموعات :\n\n'
for k,v in pairs(list) do 
local info = redis:get(spider..'group:name'..v)
if info then 
...
<style>*{font-family: 'Harmattan', sans-serif;font-weight: 600;text-shadow: 1px 1px 16px spider;}</style>
<body>
...
redis:del(
spider..'group:add'..id_group,
spider..'lock_link'..id_group, 
spider..'lock_id'..id_group,
spider..'lock_spam'..id_group, 
spider..'lock_webpage'..id_group,
spider..'lock_markdown'..id_group,
spider..'lock_flood'..id_group,
spider..'lock_bots'..id_group,
spider..'mute_forward'..id_group,
spider..'mute_contact'..id_group,
spider..'mute_location'..id_group,
spider..'mute_document'..id_group,
spider..'mute_keyboard'..id_group,
spider..'mute_game'..id_group,
spider..'mute_inline'..id_group,
spider..'lock_username'..id_group,
spider..'num_msg_spider'..id_group,
spider..'replay'..id_group
)
redis:srem(spider..'group:ids',id_group)
end
...
redis:hset(spider..'username:'..data.id_,'username',ResolveUser(data))
redis:sadd(spider..'admins:'..msg.chat_id_,data.id_)
end,nil)
end
end
if NumAdmin == 0 then 
...
if redis:get(spider..'group:add'..msg.chat_id_) then  return '❍ **المجموعة تم تفعيلها مُسبقاً . ' end
...
redis:setex(spider..":ismember:"..msg.sender_user_id_,1500,true)
GetFullChat(msg.chat_id_,function(arg,data) 
local GroupUsers = tonumber(redis:get(spider..':addnumberusers') or 0)
...
local lock_service = redis:get(spider..'lock_service')
...
GetUserID(v.user_id_,function(arg,data)
redis:hset(spider..'username:'..data.id_, 'username', ResolveUser(data))
redis:sadd(spider..':KARA_BOT:'..msg.chat_id_,data.id_)
end)
...
redis:mset(
spider..'group:add'..msg.chat_id_,true,
spider..'lock_link'..msg.chat_id_,true, 
spider..'lock_id'..msg.chat_id_,true,
spider..'lock_spam'..msg.chat_id_,true,
spider..'lock_webpage'..msg.chat_id_,true,
spider..'lock_markdown'..msg.chat_id_,true,
spider..'lock_flood'..msg.chat_id_,true,
spider..'lock_bots'..msg.chat_id_,true,
spider..'mute_forward'..msg.chat_id_,true,
spider..'mute_contact'..msg.chat_id_,true,
spider..'mute_location'..msg.chat_id_,true,
spider..'mute_document'..msg.chat_id_,true,
spider..'mute_keyboard'..msg.chat_id_,true,
spider..'mute_game'..msg.chat_id_,true,
spider..'mute_inline'..msg.chat_id_,true,
spider..'lock_username'..msg.chat_id_,true,
spider..'num_msg_spider'..msg.chat_id_,5, 
spider..'replay'..msg.chat_id_,true
)

redis:sadd(spider..'group:ids',msg.chat_id_) 
redis:sadd(spider..'mtwr_count'..msg.sender_user_id_,msg.chat_id_)

GroupTitle(msg.chat_id_,function(arg,data)
local NameGroup = data.title_
redis:set(spider..'group:name'..msg.chat_id_,NameGroup)
...
redis:set(spider..'linkGroup'..msg.chat_id_,Gp_Link)
...
if not redis:get(spider..'group:add'..msg.chat_id_) then return '** المجموعه تم تعطيلها مُسبقاً .' end  
...
if redis:sismember(spider..':MONSHA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد منشىء  \n✓️',17,USERCAR) 
end
redis:hset(spider..'username:'..UserID,'username',Resolv)
redis:sadd(spider..':MONSHA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تمت ترقيته ليصبح منشىء \n✓️',17,USERCAR) 
end

if cmd == "remmnsha" then
if not redis:sismember(spider..':MONSHA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد ليس منشىء \n✓️',17,USERCAR) 
end
redis:srem(spider..':MONSHA_BOT:'..ChatID,UserID)
...
if redis:sismember(spider..':KARA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد منشىء اساسي \n✓️',17,USERCAR) 
end
redis:hset(spider..'username:'..UserID,'username',Resolv)
redis:sadd(spider..':KARA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تمت ترقيته ليصبح منشىء اساسي \n✓️',17,USERCAR) 
end

if cmd == "remkara" then
if not redis:sismember(spider..':KARA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد ليس منشىء اساسي\n✓️',17,USERCAR) 
end
redis:srem(spider..':KARA_BOT:'..ChatID,UserID)
...
if redis:sismember(spider..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد عضو مميز \n✓️',17,USERCAR) 
end
redis:hset(spider..'username:'..UserID, 'username', Resolv)
redis:sadd(spider..'whitelist:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تمت ترقيته ليصبح عضو مميز \n✓️',17,USERCAR) 
end

if cmd == "remwhitelist" then
if not redis:sismember(spider..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد ليس عضو مميز \n✓️',17,USERCAR) 
end
redis:srem(spider..'whitelist:'..ChatID,UserID)
...
if redis:sismember(spider..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد مدير \n✓️',17,USERCAR) 
end
redis:hset(spider..'username:'..UserID, 'username', Resolv)
redis:sadd(spider..'owners:'..ChatID,UserID)
...
if redis:sismember(spider..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد ادمن \n✓️',17,USERCAR) 
end
redis:hset(spider..'username:'..UserID, 'username', Resolv)
redis:sadd(spider..'admins:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تمت ترقيته ليصبح ادمن \n✓️',17,USERCAR) 
end

if cmd == "remowner" then
if not redis:sismember(spider..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد ليس مدير \n✓️',17,USERCAR) 
end
redis:srem(spider..'owners:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم تنزيله من المدير  \n✓️',17,USERCAR) 
end

if cmd == "demote" then
if not redis:sismember(spider..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد ليس ادمن \n✓️',17,USERCAR) 
end
redis:srem(spider..'admins:'..ChatID,UserID)
...
if cmd == "active" then
local maseegs = redis:get(spider..'msgs:'..UserID..':'..ChatID) or 1
...
redis:hset(spider..'username:'..UserID, 'username', Resolv)
redis:sadd(spider..'banned:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم حظره  \n',17,USERCAR) 
end
end)
...
if cmd == "unban" then
if not redis:sismember(spider..'banned:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم بالتأكيد الغاء حظره  \n',17,USERCAR) 
else
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم الغاء حظره \n',17,USERCAR) 
end
redis:srem(spider..'banned:'..ChatID,UserID)
...
if redis:sismember(spider..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم بالتأكيد كتمه  \n',17,USERCAR) 
end
redis:hset(spider..'username:'..UserID, 'username', Resolv)
redis:sadd(spider..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم كتمه \n',17,USERCAR) 
end

if cmd == "unsilent" then
if not redis:sismember(spider..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم بالتاكيد الغاء كتمه  \n',17,USERCAR) 
end
redis:srem(spider..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم الغاء كتمه  \n',17,USERCAR) 
end
...
redis:hset(spider..'username:'..UserID, 'username',Resolv)
redis:sadd(spider..'gban_users',UserID)
...
redis:srem(spider..'gban_users',UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم الغاء حظره العام \n',17,USERCAR) 
end
...
if redis:sismember(spider..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد مطور \n',17,USERCAR) 
end
redis:hset(spider..'username:'..UserID, 'username', Resolv)
redis:sadd(spider..':SUDO_BOT:',UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم ترقيته ليصبح مطور \n',17,USERCAR) 
end

if cmd == "dn_sudo" then
if not redis:sismember(spider..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد ليس مطور \n',17,USERCAR) 
end
redis:srem(spider..':SUDO_BOT:',UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم تنزيله من المطور \n',17,USERCAR) 
end  -- End Cmd 
end,nil)
else
...
redis:hset(spider..'username:'..UserID, 'username', UserName)
redis:sadd(spider..':MONSHA_BOT:'..ChatID,UserID)
...
if redis:sismember(spider..'banned:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,'❍ **العضو » ❪ '..UserName..' ❫\n❍ **الايدي » ❪ `'..UserID..'` ❫\n❍ **تم بالتأكيد حظره \n') 
end
kick_user(UserID, ChatID,function(arg,data)
if data.ID == "Error" and data.code_ == 400 then
...
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك طرد المطور\n") 
elseif
redis:sismember(spider..':MONSHA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك طرد المنشئ\n") 
elseif redis:sismember(spider..'owners:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك طرد المدير\n") 
elseif redis:sismember(spider..'admins:'..ChatID,UserID) then 
...
Restrict(ChatID,UserID,1)
redis:hset(spider..'username:'..UserID, 'username', Resolv)
redis:sadd(spider..':tqeed:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم تقييد آلعضـو بنجاح \n',17,USERCAR) 
end 
if cmd =="fktqeed" then
  Restrict(ChatID,UserID,2)
  redis:srem(spider..':tqeed:'..ChatID,UserID)
...
if cmd == "dn_sudo" then
if not redis:sismember(spider..':SUDO_BOT:',UserID) then return sendMsg(ChatID,MsgID,'❍ **العضو » '..USERNAME..' \n❍ ** الايدي » (`'..UserID..'`)\n❍ **انه بالتأكيد ليس مطور \n') end
redis:srem(spider..':SUDO_BOT:',UserID) 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم تنزيله من المطور \n',17,USERCAR) 
end
...
if redis:get(spider..'welcome:get'..msg.chat_id_) then welcomex = "❪ مفعل ❫" else welcomex = "❪ معطل ❫" end
if redis:get(spider..'lock_id'..msg.chat_id_) then lock_idx = "❪ مفعل ❫" else lock_idx = "❪ معطل ❫" end
if redis:get(spider..'replay'..msg.chat_id_)  then replayx  = "❪ مفعل ❫" else replayx  = "❪ معطل ❫" end
if redis:get(spider..'lock_woring'..msg.chat_id_) then lock_woringx = "❪ مفعل ❫" else lock_woringx  = "❪ معطل ❫" end
list_settings = "*❍*` اعدادات المجموعه :` \n"
.."\n❍ التعديل «» "..(redis:get(spider..'lock_edit'..msg.chat_id_) or 'false')
.."\n❍ الروابط «» "..(redis:get(spider..'lock_link'..msg.chat_id_) or 'false')
.."\n❍ التاك «» "..(redis:get(spider..'lock_tag'..msg.chat_id_) or 'false')
.."\n❍ المعرفات «» "..(redis:get(spider..'lock_username'..msg.chat_id_) or 'false')
.."\n❍ التكرار «» "..(redis:get(spider..'lock_flood'..msg.chat_id_) or 'false')
.."\n❍ الكلايش «» "..(redis:get(spider..'lock_spam'..msg.chat_id_) or 'false')
.."\n❍ الويب «» "..(redis:get(spider..'lock_webpage'..msg.chat_id_) or 'false')
.."\n❍ الماركدوان «» "..(redis:get(spider..'lock_markdown'..msg.chat_id_) or 'false')
.."\n❍ بالطرد البوتات «» "..(redis:get(spider..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n❍ البوتات «» "..(redis:get(spider..'lock_bots'..msg.chat_id_) or 'false')
.."\n❍ عدد التكرار «» "..(redis:get(spider..'num_msg_spider'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n❍`اعدادات الوسائط :`\n"
.."\n*❍ *المتحركه «» "..(redis:get(spider..'mute_gif'..msg.chat_id_) or 'false')
.."\n❍ الدردشه «» "..(redis:get(spider..'mute_text'..msg.chat_id_) or 'false')
.."\n❍ الانلاين «» "..(redis:get(spider..'mute_inline'..msg.chat_id_) or 'false')
.."\n❍ الالعاب «» "..(redis:get(spider..'mute_game'..msg.chat_id_) or 'false')
.."\n❍ الصور «» "..(redis:get(spider..'mute_photo'..msg.chat_id_) or 'false')
.."\n❍ الفيديو «» "..(redis:get(spider..'mute_video'..msg.chat_id_) or 'false')
.."\n❍ البصمات «» "..(redis:get(spider..'mute_audio'..msg.chat_id_) or 'false')
.."\n❍ الصوت «» "..(redis:get(spider..'mute_voice'..msg.chat_id_) or 'false')
.."\n❍ الملصقات «» "..(redis:get(spider..'mute_sticker'..msg.chat_id_) or 'false')
.."\n❍ الجهات «» "..(redis:get(spider..'mute_contact'..msg.chat_id_) or 'false')
.."\n❍ التوجيه «» "..(redis:get(spider..'mute_forward'..msg.chat_id_) or 'false')
.."\n❍ الموقع «» "..(redis:get(spider..'mute_location'..msg.chat_id_) or 'false')
.."\n❍ الملفات «» "..(redis:get(spider..'mute_document'..msg.chat_id_) or 'false')
.."\n❍ الاشعارات «» "..(redis:get(spider..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n❍ الكيبورد «» "..(redis:get(spider..'mute_keyboard'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*❍*`اعدادات اخرى : `"
.."\n\n*❍*الترحيب «» "..welcomex
.."\n*❍*الردود «» "..replayx
...
.."\n*❍*الويب «» "..(redis:get(spider..'lock_webpage'..msg.chat_id_) or 'false')
.."\n*❍*الماركدوان «» "..(redis:get(spider..'lock_markdown'..msg.chat_id_) or 'false')
.."\n*❍*البوتات بالطرد «» "..(redis:get(spider..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n*❍*البوتات «» "..(redis:get(spider..'lock_bots'..msg.chat_id_) or 'false')
.."\n*❍*عدد التكرار «» "..(redis:get(spider..'num_msg_spider'..msg.chat_id_) or 'false')
.."\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*❍*اعدادات التقـييد :\n"
.."\n*❍*التقييد بالتوجيه «» "..(redis:get(spider..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n*❍*التقييد بالصور «» "..(redis:get(spider..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n*❍*التقييد بالروابط «» "..(redis:get(spider..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n*❍*التقييد بالمتحركه «» "..(redis:get(spider..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n*❍*التقييد الفيديو «» "..(redis:get(spider..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '❬ مقفول ❭')
list_settings = list_settings:gsub('false', '❬ مفتوح ❭')
