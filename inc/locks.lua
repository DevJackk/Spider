...
function unlock_waring(msg)
  ...
  else redis:set(Spider..'lock_woring'..msg.chat_id_,true)
  ...
  if not msg.Admin then return "-**هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n❕" end
  if not redis:get(Spider..'lock_woring'..msg.chat_id_) then 
  return "-**أهلا عزيزي "..msg.TheRankCmd.."\n-**التحذير بالتأكيد معطل\n✓" 
  else
  redis:del(Spider..'lock_woring'..msg.chat_id_) 
  ...
  if not msg.Admin then return "-**هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n❕" end
  if not redis:get(Spider..'lock_id'..msg.chat_id_) then 
  return "-**أهلا عزيزي "..msg.TheRankCmd.."\n-**الايدي بالتأكيد معطل\n✓" 
  else
  redis:del(Spider..'lock_id'..msg.chat_id_) 
  ...
  redis:set(Spider..'lock_id'..msg.chat_id_,true)  
  ...
  else redis:set(Spider..'welcome:get'..msg.chat_id_,true)  
  ...
  if not msg.Admin then return "-**هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n❕" end
  if not redis:get(Spider..'welcome:get'..msg.chat_id_) then 
  ...
  Spider..'mute_gif'..msg.chat_id_,true,
  Spider..'mute_photo'..msg.chat_id_,true,
  Spider..'mute_audio'..msg.chat_id_,true,
  Spider..'mute_voice'..msg.chat_id_,true,
  Spider..'mute_sticker'..msg.chat_id_,true,
  ...
  if not msg.Director then return "-**هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n❕" end
  redis:del(
  Spider..'lock_username'..msg.chat_id_,
  Spider..'mute_gif'..msg.chat_id_,
  Spider..'mute_photo'..msg.chat_id_,
  Spider..'mute_audio'..msg.chat_id_,
  Spider..'mute_voice'..msg.chat_id_,
  Spider..'mute_sticker'..msg.chat_id_,
  Spider..'mute_forward'..msg.chat_id_,
  Spider..'mute_contact'..msg.chat_id_,
  Spider..'mute_location'..msg.chat_id_,
  Spider..'mute_document'..msg.chat_id_,
  Spider..'lock_link'..msg.chat_id_,
  Spider..'lock_tag'..msg.chat_id_,
  Spider..'lock_edit'..msg.chat_id_,
  Spider..'lock_spam'..msg.chat_id_,
  Spider..'lock_bots'..msg.chat_id_,
  Spider..'lock_webpage'..msg.chat_id_,
  Spider..'mute_video'..msg.chat_id_,
  Spider..':tqeed_video:'..msg.chat_id_,
  Spider..':tqeed_photo:'..msg.chat_id_,
  Spider..':tqeed_gif:'..msg.chat_id_,
  Spider..':tqeed_fwd:'..msg.chat_id_,
  Spider..':tqeed_link:'..msg.chat_id_,
  Spider..'mute_inline'..msg.chat_id_
  )
  return "-**أهلا عزيزي "..msg.TheRankCmd.."\n-**تــــم فتح الكل  \n✓"
  end
  ...
  if not msg.Director then return "-**هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n❕" end
  if redis:get(Spider..':tqeed_photo:'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**التقييد بالصور بالتأكيد تــــم قفله \n✓'
  else
  redis:del(Spider..'mute_photo'..msg.chat_id_)
  redis:set(Spider..':tqeed_photo:'..msg.chat_id_,true)
  ...
  if not msg.Director then return "-**هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n❕" end
  if not redis:get(Spider..':tqeed_photo:'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**التقييد بالصور بالتأكيد تــــم فتحه \n✓'
  else 
  redis:del(Spider..':tqeed_photo:'..msg.chat_id_)
  ...
  if not msg.Director then return "-**هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n❕" end
  if redis:get(Spider..':tqeed_video:'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**التقييد بالفيديو بالتأكيد تــــم قفله \n✓'
  else
  redis:del(Spider..':tqeed_video:'..msg.chat_id_)
  redis:set(Spider..':tqeed_video:'..msg.chat_id_,true)
  ...
  if not msg.Director then return "-**هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n❕" end
  if not redis:get(Spider..':tqeed_video:'..msg.chat_id_) then
  ...
  if not msg.Director then return "-**هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n❕" end
  if redis:get(Spider..':tqeed_gif:'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**التقييد المتحركه بالتأكيد تــــم قفله \n✓'
  else
  redis:del(Spider..'mute_gif'..msg.chat_id_)
  redis:set(Spider..':tqeed_gif:'..msg.chat_id_,true)
  ...
  if not msg.Director then return "-**هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n❕" end
  if not redis:get(Spider..':tqeed_gif:'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**التقييد المتحركه بالتأكيد تــــم فتحه \n✓'
  else 
  redis:del(Spider..':tqeed_gif:'..msg.chat_id_)
  ...
  if not msg.Director then return "-**هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n❕" end
  if redis:get(Spider..':tqeed_fwd:'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**التقييد بالتوجيه بالتأكيد تــــم قفله \n✓'
  else
  redis:del(Spider..'mute_forward'..msg.chat_id_)
  redis:set(Spider..':tqeed_fwd:'..msg.chat_id_,true)
  ...
  if not msg.Director then return "-**هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n❕" end
  if not redis:get(Spider..':tqeed_fwd:'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**التقييد التوجيه بالتأكيد تــــم فتحه \n✓'
  else 
  redis:del(Spider..':tqeed_fwd:'..msg.chat_id_)
  ...
  if not msg.Director then return "-**هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n❕" end
  if redis:get(Spider..':tqeed_link:'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**التقييد بالروابط بالتأكيد تــــم قفله \n✓'
  else
  redis:set(Spider..':tqeed_link:'..msg.chat_id_,true)
  ...
  if not msg.Director then return "-**هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n❕" end
  if not redis:get(Spider..':tqeed_link:'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**التقييد بالروابط بالتأكيد تــــم فتحه \n✓'
  else 
  redis:del(Spider..':tqeed_link:'..msg.chat_id_)
  ...
  if redis:get(Spider..'lock_twasel') then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**التواصل بالتاكيد تــــم تعطيله \n✓'
  else
  redis:set(Spider..'lock_twasel',true)
  ...
  if not redis:get(Spider..'lock_brod') then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**اذاعه المطورين بالتاكيد تــــم تعطيله \n✓'
  else
  redis:del(Spider..'lock_brod')
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم تعطيل اذاعه المطورين  \n✓'
  end
  end
  function unlock_brod(msg)
  if not msg.SudoBase then return "-**هذا الامر يخص المطور فقط  ❕" end
  if redis:get(Spider..'lock_brod') then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**اذاعه المطورين بالتاكيد تــــم تفعيله \n✓'
  else 
  redis:set(Spider..'lock_brod',true)
  ...
  if not redis:get(Spider..'replay'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**الردود بالتاكيد تــــم تعطيله \n✓'
  else
  redis:del(Spider..'replay'..msg.chat_id_)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم تعطيل الردود  \n✓'
  end
  end
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if redis:get(Spider..'replay'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**الردود بالتاكيد تــــم تفعيله \n✓'
  else 
  redis:set(Spider..'replay'..msg.chat_id_,true)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم تفعيل الردود  \n✓'
  end
  end
  ...
  if not msg.SudoBase then return "-**هذا الامر يخص المطور الاساسي فقط  \n❕" end
  if not redis:get(Spider..'lock_service') then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم بالتاكيد تعطيل نظام البوت خدمي \n✓'
  else
  redis:del(Spider..'lock_service')
  ...
  redis:set(Spider..'lock_service',true)
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if redis:get(Spider..'lock_link'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**الروابط بالتأكيد تــــم قفلها \n✓'
  else
  redis:set(Spider..'lock_link'..msg.chat_id_,true)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم قفل الروابط \n✓'
  end
  end
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if not redis:get(Spider..'lock_link'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**الروابط بالتأكيد تــــم فتحها \n✓'
  else 
  redis:del(Spider..'lock_link'..msg.chat_id_)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم فتح الروابط \n✓'
  end
  end
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if redis:get(Spider..'lock_tag'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**التاك بالتأكيد تــــم قفله \n✓'
  else
  redis:set(Spider..'lock_tag'..msg.chat_id_,true)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم قفل التاك (#) \n✓'
  end
  end
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if not redis:get(Spider..'lock_tag'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**التاك بالتأكيد تــــم فتحه \n✓'
  else 
  redis:del(Spider..'lock_tag'..msg.chat_id_)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم فتح التاك  \n✓'
  end
  end
  ---------------Lock UserName-------------------
  ...
  if redis:get(Spider..'lock_username'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**المعرفات بالتأكيد تــــم قفله \n✓'
  else
  redis:set(Spider..'lock_username'..msg.chat_id_,true)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم قفل المعرفات \n✓'
  end
  end
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if not redis:get(Spider..'lock_username'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**آلمـعرفآت بآلتآگيد تــــم فتحهآ  \n✓'
  else 
  redis:del(Spider..'lock_username'..msg.chat_id_)
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if redis:get(Spider..'lock_edit'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**التعديل بالتأكيد تــــم قفله \n✓'
  else
  redis:set(Spider..'lock_edit'..msg.chat_id_,true)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم قفل التعديل \n✓'
  end
  end
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if not redis:get(Spider..'lock_edit'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**التعديل بالتأكيد تــــم فتحه \n✓'
  else 
  redis:del(Spider..'lock_edit'..msg.chat_id_)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم فتح التعديل \n✓'
  end
  end
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if   redis:get(Spider..'lock_spam'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**الكلايش بالتأكيد تــــم قفلها \n✓'
  else
  redis:set(Spider..'lock_spam'..msg.chat_id_,true)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم قفل الكلايش \n✓'
  end
  end
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if not redis:get(Spider..'lock_spam'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**الكلايش بالتأكيد تــــم فتحها \n✓'
  else 
  redis:del(Spider..'lock_spam'..msg.chat_id_)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم فتح الكلايش \n✓'
  end
  end
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if redis:get(Spider..'lock_flood'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**التكرار بالتأكيد تــــم قفله \n✓'
  else
  redis:set(Spider..'lock_flood'..msg.chat_id_,true)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم قفل التكرار \n✓'
  end
  end
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if not redis:get(Spider..'lock_flood'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**التكرار بالتأكيد تــــم فتحه \n✓'
  else 
  redis:del(Spider..'lock_flood'..msg.chat_id_)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم فتح التكرار \n✓'
  end
  end
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if redis:get(Spider..'lock_bots'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**البوتات بالتأكيد تــــم قفلها \n✓'
  else
  redis:set(Spider..'lock_bots'..msg.chat_id_,true)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم قفل البوتات \n✓'
  end
  end
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if not redis:get(Spider..'lock_bots'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**البوتات بالتأكيد تــــم فتحها \n✓'
  else 
  redis:del(Spider..'lock_bots_by_kick'..msg.chat_id_)
  redis:del(Spider..'lock_bots'..msg.chat_id_)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم فتح البوتات \n✓'
  end
  end
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if redis:get(Spider..'lock_join'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**الاضافه بالتاكيد تــــم قفلها \n✓'
  else
  redis:set(Spider..'lock_join'..msg.chat_id_,true)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم قفل الاضافه \n✓'
  end
  end
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if not redis:get(Spider..'lock_join'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**الاضافه بالتاكيد تــــم فتحها \n✓'
  else 
  redis:del(Spider..'lock_join'..msg.chat_id_)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم فتح الاضافه \n✓'
  end
  end
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if redis:get(Spider..'lock_markdown'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**الماركدوان بالتاكيد تــــم قفله \n✓'
  else
  redis:set(Spider..'lock_markdown'..msg.chat_id_,true)
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if not redis:get(Spider..'lock_markdown'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**الماركدوان بالتأكيد تــــم فتحه \n✓'
  else 
  redis:del(Spider..'lock_markdown'..msg.chat_id_)
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if redis:get(Spider..'lock_webpage'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**الويب بالتأكيد تــــم قفله \n✓'
  else
  redis:set(Spider..'lock_webpage'..msg.chat_id_,true)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم قفل الويب \n✓'
  end
  end
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if not redis:get(Spider..'lock_webpage'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**الويب بالتأكيد تــــم فتحه \n✓'
  else 
  redis:del(Spider..'lock_webpage'..msg.chat_id_)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم فتح الويب \n✓'
  end
  end
  ---------------Mute Gif-------------------
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if redis:get(Spider..'mute_gif'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**المتحركه بالتأكيد تــــم قفلها \n✓'
  else
  redis:set(Spider..'mute_gif'..msg.chat_id_,true)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم قفل المتحركه \n✓'
  end
  end
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if not redis:get(Spider..'mute_gif'..msg.chat_id_) then
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if redis:get(Spider..'mute_inline'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**الانلاين بالتأكيد تــــم قفله \n✓'
  else
  redis:set(Spider..'mute_inline'..msg.chat_id_,true)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم قفل الانلاين \n✓'
  end
  end
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if not redis:get(Spider..'mute_inline'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**الانلاين بالتأكيد تــــم فتحه \n✓'
  else 
  redis:del(Spider..'mute_inline'..msg.chat_id_)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم فتح الانلاين \n✓'
  end
  end
  ---------------Mute Text-------------------
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if redis:get(Spider..'mute_text'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**الدرشه بالتأكيد تــــم قفلها \n✓'
  else
  redis:set(Spider..'mute_text'..msg.chat_id_,true)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم قفل الدردشه \n✓'
  end
  end
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if not redis:get(Spider..'mute_text'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**الدردشه بالتأكيد تــــم فتحها \n✓'
  else 
  redis:del(Spider..'mute_text'..msg.chat_id_,true)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم فتح الدردشه \n✓'
  end
  end
  ---------------Mute photo-------------------
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if redis:get(Spider..'mute_photo'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**الصور بالتأكيد تــــم قفلها \n✓'
  else
  redis:set(Spider..'mute_photo'..msg.chat_id_,true)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم قفل الصور \n✓'
  end
  end
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if not redis:get(Spider..'mute_photo'..msg.chat_id_)then
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if redis:get(Spider..'mute_video'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**الفيديو بالتأكيد تــــم قفله \n✓'
  else
  redis:set(Spider..'mute_video'..msg.chat_id_,true)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم قفل الفيديو \n✓'
  end
  end
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if not redis:get(Spider..'mute_video'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**الفيديو بتأكيد تــــم فتحه \n✓'
  else 
  redis:del(Spider..'mute_video'..msg.chat_id_)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم فتح الفيديو \n✓'
  end
  end
  ---------------Mute Audio-------------------
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if redis:get(Spider..'mute_audio'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**البصمات بالتأكيد تــــم قفلها \n✓'
  else
  redis:set(Spider..'mute_audio'..msg.chat_id_,true)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم قفل البصمات \n✓'
  end
  end
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if not redis:get(Spider..'mute_audio'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**البصمات بالتأكيد تــــم فتحها \n✓'
  else 
  redis:del(Spider..'mute_audio'..msg.chat_id_)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم فتح البصمات \n✓'
  end
  end
  ---------------Mute Voice-------------------
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if   redis:get(Spider..'mute_voice'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**الصوت بالتأكيد تــــم قفله \n✓'
  else
  redis:set(Spider..'mute_voice'..msg.chat_id_,true)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم قفل الصوت \n✓'
  end
  end
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if not redis:get(Spider..'mute_voice'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**الصوت بالتأكيد تــــم فتحه \n✓'
  else 
  redis:del(Spider..'mute_voice'..msg.chat_id_)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم فتح الصوت \n✓'
  end
  end
  ---------------Mute Sticker-------------------
  ...
  if   redis:get(Spider..'mute_sticker'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**الملصقات بالتأكيد تــــم قفلها \n✓'
  else
  redis:set(Spider..'mute_sticker'..msg.chat_id_,true)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم قفل الملصقات \n✓'
  end
  end
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if not redis:get(Spider..'mute_sticker'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**الملصقات بالتأكيد تــــم فتحها \n✓'
  else 
  redis:del(Spider..'mute_sticker'..msg.chat_id_)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم فتح الملصقات \n✓'
  end
  end
  ---------------Mute Contact-------------------
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if redis:get(Spider..'mute_contact'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**جهات الاتصال بالتأكيد تــــم قفلها \n✓'
  else
  redis:set(Spider..'mute_contact'..msg.chat_id_,true)
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if not redis:get(Spider..'mute_contact'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**جهات الاتصال بالتأكيد تــــم فتحها \n✓'
  else 
  redis:del(Spider..'mute_contact'..msg.chat_id_)
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if redis:get(Spider..'mute_forward'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**التوجيه بالتأكيد تــــم قفلها \n✓'
  else
  redis:set(Spider..'mute_forward'..msg.chat_id_,true)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم قفل التوجيه \n✓'
  end
  end
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if not redis:get(Spider..'mute_forward'..msg.chat_id_) then
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if redis:get(Spider..'mute_location'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**الموقع بالتأكيد تــــم قفله \n✓'
  else
  redis:set(Spider..'mute_location'..msg.chat_id_,true)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم قفل الموقع \n✓'
  end
  end
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if not redis:get(Spider..'mute_location'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**الموقع بالتأكيد تــــم فتحه \n✓'
  else 
  redis:del(Spider..'mute_location'..msg.chat_id_)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم فتح الموقع \n✓'
  end
  end
  ---------------Mute Document-------------------
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if redis:get(Spider..'mute_document'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**الملفات بالتأكيد تــــم قفلها \n✓'
  else
  redis:set(Spider..'mute_document'..msg.chat_id_,true)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم قفل الملفات \n✓'
  end
  end
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if not redis:get(Spider..'mute_document'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**الملفات بالتأكيد تــــم فتحها \n✓'
  else 
  redis:del(Spider..'mute_document'..msg.chat_id_)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم فتح الملفات \n✓'
  end
  end
  ---------------Mute TgService-------------------
  ...
  redis:set(Spider..'mute_tgservice'..msg.chat_id_,true)
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if not redis:get(Spider..'mute_tgservice'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**الاشعارات بالتأكيد تــــم فتحها \n✓'
  else 
  redis:del(Spider..'mute_tgservice'..msg.chat_id_)
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if redis:get(Spider..'mute_keyboard'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**الكيبورد بالتأكيد تــــم قفله \n✓'
  else
  redis:set(Spider..'mute_keyboard'..msg.chat_id_,true)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم قفل الكيبورد \n✓'
  end
  end
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if not redis:get(Spider..'mute_keyboard'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**الكيبورد بالتأكيد تــــم فتحه \n✓'
  else 
  redis:del(Spider..'mute_keyboard'..msg.chat_id_)
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تــــم فتح الكيبورد \n✓'
  end
  end
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if redis:get(Spider..'lock_bots_by_kick'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**البوتات بالطرد بالتاكيد تــــم قفله \n✓'
  else
  redis:set(Spider..'lock_bots'..msg.chat_id_,true)
  redis:set(Spider..'lock_bots_by_kick'..msg.chat_id_,true)
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if not redis:get(Spider..'lock_bots_by_kick'..msg.chat_id_) then
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if redis:get(Spider..'lock_pin'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**التثبيت بالفعل مقفل \n✓'
  else
  redis:set(Spider..'lock_pin'..msg.chat_id_,true) 
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**تـم قفل التثبيت \n✓'
  end
  end
  ...
  if not msg.Admin then return "-**هذا الامر يخص الادمنيه فقط  ❕" end
  if not redis:get(Spider..'lock_pin'..msg.chat_id_) then
  return '-**أهلا عزيزي '..msg.TheRankCmd..'\n-**التثبيت بالفعل مفتوح \n✓'
  else 
  redis:del(Spider..'lock_pin'..msg.chat_id_)
  return '- **أهلا عزيزي '..msg.TheRankCmd..'\n- **تـم فتح التثبيت   \n✓'
  end
  end
